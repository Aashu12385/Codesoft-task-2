...
score_frame = Frame(root,  bg = "#4adcec")
score_frame.pack()
...
choice_frame = Frame(root,bg= "#4adcec")
...
button_frame = Frame(root, bg= "#4adcec")
...
footer = Label(
    root,
    text="Made with Mind  using Python Tkinter",
    font=("Segoe UI", 12),
    bg =  "#4adcec",
    fg="black"
)
